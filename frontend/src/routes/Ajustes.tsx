...
export function Ajustes() {
  ...
  return (
    <div className="mx-auto flex min-h-svh max-w-sm flex-col">
      ...
      <div className="flex flex-1 flex-col gap-5.5 px-5 pt-2 pb-4">
      ...
      <div className="px-5 pb-6">
        <Button
          variant="outline"
          className="border-destructive/25 text-destructive hover:bg-destructive/5 w-full rounded-2xl py-3"
